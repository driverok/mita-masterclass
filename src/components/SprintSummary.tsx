  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-3">
        <h3 className="font-semibold text-gray-800 dark:text-white">{sprint.name}</h3>
        <span
      ...
      <div className="grid grid-cols-3 gap-2 text-center text-sm">
        <div>
          <div className="font-semibold text-gray-800 dark:text-white">{issues.length}</div>
          <div className="text-gray-500 dark:text-gray-400">Issues</div>
        </div>
        <div>
          <div className="font-semibold text-gray-800 dark:text-white">{daysElapsed}</div>
          <div className="text-gray-500 dark:text-gray-400">Days In</div>
        </div>
        <div>
          <div className="font-semibold text-gray-800 dark:text-white">{daysRemaining}</div>
